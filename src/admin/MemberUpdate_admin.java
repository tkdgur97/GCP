...
public class MemberUpdate_admin extends JFrame implements ActionListener {
	...
	public MemberUpdate_admin(MemberDTO dto) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == btnUpdateCom) {
			...
			String result;
			try {
				result = new TCPClient1().userInfoChange_admin(userId +"\n"+pw+ "\n" + name + "\n" + tel + "\n" + add);
				String[] buttons = { "확인"};
